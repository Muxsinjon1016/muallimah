...
/>
              <div className="p-[20px] md:px-[44px] md:py-[30px]">
                ...
                <h1 className="text-2xl font-bold text-left text-[#ff4756]">{feedbackData[index].title}</h1>
              ...
              <div className="mt-32 justify-center mb-4 md:mt-25 p-10 w-72 h-[261px] rounded-lg bg-white" style={{ boxShadow: "0px 20px 40px -5px rgba(0,0,0,0.04)" }}>
                <img
                  src={feedbackData[index].img}
                  alt="feedback"
                  className="w-[200px] md:w-[300px] lg:w-[600px] h-auto"
                />
                <p className="w-[238px] text-xl font-semibold pt-4 pl-4 text-left text-[#00235a]">My Grammar Notes</p>
